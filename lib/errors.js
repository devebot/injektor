...
var errors = {
  ...
  DependencyCycleDetectedError: CustomError.clone(),
  DuplicatedRelativeNameError: CustomError.clone(),
...
util.inherits(errors.DependencyCycleDetectedError, Error);
util.inherits(errors.DuplicatedRelativeNameError, Error);
